...
//                }.bind(this)}
    >
        <div key="chart-1" className="chartStyle" ref={this.conRef}
        data-grid={{x: 0, y: 0, w: 3, h: 3}}>
        <ChartTest id="chart-1"
        ...
        >
          ...
          <div key="chart-2" className="chartStyle"
        data-grid={{x: 0, y: 0, w: 3, h: 3}}>  
          <ChartTest id="chart-2"  
        Highcharts={null}
        options={options2}
        ref= {this.myRef}
        >
          ...
          <div key="chart-3" className="chartStyle"
          data-grid={{x: 0, y: 0, w: 3, h: 3}}>
          <ChartTest id="chart-3"
        Highcharts={null}
        options={options3}
        ref= {this.myRef}
        >
